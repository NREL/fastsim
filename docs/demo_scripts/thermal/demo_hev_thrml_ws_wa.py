...
warm start and warm ambient conditions, where the cabin, battery, and
engine all begin hot and the surrounding air is also hot.
"""
...
Load a thermal HEV, set warm initial temperatures for the cabin, battery,
and engine with a warm ambient temperature, and run the simulation.
"""
...
temperatures, and road loads under warm start, warm ambient conditions.
"""
