...
def abc_to_drag_coeffs(veh: Vehicle,
    ...
    cur_ambient_air_density_kg__m3 = get_rho_air(custom_rho_temp_degC, custom_rho_elevation_m) if custom_rho else props.air_density_kg_per_m3

    vmax_mph = 70.0
    
    a_newton = a_lbf * params.N_PER_LBF
    b_newton__mps = b_lbf__mph * params.N_PER_LBF * params.MPH_PER_MPS
    c_newton__mps2 = c_lbf__mph2 * params.N_PER_LBF * params.MPH_PER_MPS * params.MPH_PER_MPS
    ...
    sd_coast = fsim.simdrive.RustSimDrive(cyc, veh) if use_rust else fsim.simdrive.SimDrive(cyc, veh)
    sd_coast.impose_coast = [True] * len(sd_coast.impose_coast)
    sd_coast.sim_drive()
...
def drag_coeffs_to_abc(veh,
    ...
    c_newton__mps2 = drag_coef * (0.5 * veh_fa_m2 * cur_ambient_air_density_kg__m3) 
    b_newton__mps = 0.0
    ...
    if fit_with_curve:
        ...
        c_lbf__mph2  = c_newton__mps2 / params.N_PER_LBF / params.MPH_PER_MPS / params.MPH_PER_MPS
