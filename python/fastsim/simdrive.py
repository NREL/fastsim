...
class SimulationDrive:
    ...
    available_signals = {
   'Fuel Cell Output Power Achieved': 'fc_kw_out_ach',
   'ESS Output Power Achieved': 'ess_kw_out_ach',
   'Fuel Cell Input Power Achieved': 'fc_kw_in_ach',
   ...
   'Current Max Fuel Cell Output Power': 'cur_max_fc_kw_out',
   ...
   'Fuel Cell Energy (KJ)': 'fc_kj',
   'Fuel Cell Power Gap from Efficiency': 'fc_kw_gap_fr_eff',
   'Fuel Cell Output Power Achieved Percentage': 'fc_kw_out_ach_pct',
   'Fuel Cell Time On': 'fc_time_on',
   'Fuel Cell Transmission Limit Power': 'fc_trans_lim_kw',
