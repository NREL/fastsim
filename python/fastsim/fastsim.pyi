...
from typing import Dict, List, Tuple, Optional, ByteString, Any, Callable, TypeVar, Union, BinaryIO, TextIO, overload
from abc import ABC
...
T = TypeVar('T', bound='SerdeAPI')

class SerdeAPI(object):
    def init(self) -> None: ...
    @classmethod
    def from_file(cls, file_path: Union[str, Path], skip_init: bool = False) -> Self: ...
    def to_file(self, file_path: Union[str, Path]) -> None: ...
    
    @classmethod
    def from_resource(cls, resource_path: Union[str, Path], skip_init: bool = False) -> Self: ...
    @classmethod
    ...
    @classmethod
    def from_str(cls, contents: str, format: str, skip_init: bool = False) -> Self: ...
...
class Vehicle(SerdeAPI):
    @classmethod
    def try_from_fastsim2(cls, file_path: Union[str, Path]) -> Vehicle: ...
    ...
    def list_resources(cls) -> List[str]: ...
    @classmethod
    def from_f2_file(cls, file_path: Union[str, Path]) -> Vehicle: ...
    def clear(self) -> None: ...

class SimDrive(SerdeAPI):
    def __new__(cls, veh: Vehicle, cyc: Cycle, sim_params: Optional[SimParams] = None) -> SimDrive: ...
    def walk_once(self) -> bool: ...
    def walk(self) -> bool: ...
    def to_fastsim2(self) -> fastsim_2.simdrive.RustSimDrive: ...
