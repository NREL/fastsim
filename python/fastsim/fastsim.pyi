...
class Maneuver(SerdeAPI):
    @classmethod
    def create_from(cls, cyc: Cycle, veh: Vehicle) -> Maneuver: ...
    def apply_maneuvers(self) -> Cycle: ...
    def is_coasting(self) -> list[float]: ...
...
class Vehicle(SerdeAPI):
    ...
    def use_stop_start_controller(self) -> None: ...
    def use_normal_controller(self) -> None: ...
    def set_dfco_params(
        self,
        enabled: bool,
        min_dfco_speed_m_per_s: float,
        max_accel_for_dfco_m_per_s2: float,
    ): ...
