...
FASTSim (**Future Automotive Systems Technology Simulator**) is an open-source vehicle powertrain simulation tool for evaluating the efficiency and performance of on-road vehicles.
