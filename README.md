...
- Hard way (a couple of extra steps are required): 
    ...
    1. In `fastsim/rust/fastsim-py`, you should now be able to run `maturin develop --release`, which will enable the tests that use rust to run.  You should also now be able to run `fastsim/fastsim/demos/demo.py`.
...
# Usage
To see and run examples, navigate to fastsim/demos and run the various *demo.py files to see fastsim use cases. There are other examples in fastsim/tests.  
