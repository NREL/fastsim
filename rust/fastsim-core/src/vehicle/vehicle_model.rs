...
impl Vehicle {
    ...
    pub fn to_fastsim2(&self) -> anyhow::Result<fastsim_2::vehicle::RustVehicle> {
        let mut veh = fastsim_2::vehicle::RustVehicle{
            ...
            trans_kg_doc: None,
            val0_to60_mph: todo!(),
            val_cd_range_mi: todo!(),
            val_comb_kwh_per_mile: todo!(),
            val_comb_mpgge: 0.,
            val_const45_mph_kwh_per_mile: 0.,
            val_const55_mph_kwh_per_mile: 0.,
            val_const60_mph_kwh_per_mile: 0.,
            val_const65_mph_kwh_per_mile: 0.,
            val_ess_life_miles: 0.,
            val_hwy_kwh_per_mile: 0.,
            val_hwy_mpgge: 0.,
            val_msrp: 0.,
            val_range_miles: 0.,
            val_udds_kwh_per_mile: 0.,
            val_udds_mpgge: 0.,
            val_unadj_hwy_kwh_per_mile: 0.,
            val_unadj_udds_kwh_per_mile: 0.,
            val_veh_base_cost: 0.,
