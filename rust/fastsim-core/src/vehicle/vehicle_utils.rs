...
pub fn abc_to_drag_coeffs(
    ...
    let a_newton: f64 = a_lbf * crate::params::N_PER_LBF;
    let _b_newton__mps: f64 = b_lbf__mph * crate::params::N_PER_LBF * crate::params::MPH_PER_MPS;
    let c_newton__mps2: f64 = c_lbf__mph2
        * crate::params::N_PER_LBF
        * crate::params::MPH_PER_MPS
        * crate::params::MPH_PER_MPS;
    ...
    let cyc: Cycle = Cycle::new(
        ...
        Array::linspace(vmax_mph / crate::params::MPH_PER_MPS, 0.0, cd_len).to_vec(),
        vec![0.0; cd_len],
        vec![0.0; cd_len],
        String::from("cycle"),
    );
