...
fn test_get_label_fe_phev() {
    ...
    let udds: PHEVCycleCalc = PHEVCycleCalc {
        ...
        lab_iter_uf: Array::from_vec(vec![
            0., 0.16268, 0.28152, 0.41188, 0.51506, 0.59611, 0.64532, 0.69897, 0.74176, 0.77648,
            0.79825, 0.82264, 0.84278,
        ]),
        lab_iter_uf_kwh_per_mi: Array::from_vec(vec![
            0., 0.0271807, 0.01985588, 0.02178065, 0.0172394, 0.0135419, 0.00822205, 0.00896388,
            0.00714939, 0.00580104, 0.00363735, 0.0040751, 0.00028071, 0.,
        ]),
        lab_iter_kwh_per_mi: Array::from_vec(vec![
            0., 0.16708079, 0.16708079, 0.16708079, 0.16708079, 0.16708079, 0.16708079, 0.16708079,
            0.16708079, 0.16708079, 0.16708079, 0.16708079, 0.01393769, 0.,
        ]),
        ...
        adj_iter_kwh_per_mi: Array::from_vec(vec![
            0., 0.23868684, 0.23868684, 0.23868684, 0.23868684, 0.23868684, 0.23868684, 0.23868684,
            0.23868684, 0.23868684, 0.23868684, 0.23868684, 0.01991099, 0.,
        ]),
        ...
        adj_iter_uf_kwh_per_mi: Array::from_vec(vec![
            0., 0.02835122, 0.02043637, 0.02687136, 0.0155051, 0.02018813, 0.01691096, 0.00962863,
            0.01247616, 0.00714151, 0.00932549, 0.00784802, 0.00038647, 0.,
        ]),
    ...
    let hwy: PHEVCycleCalc = PHEVCycleCalc {
        ...
        lab_iter_uf_kwh_per_mi: Array::from_vec(vec![
            0., 0.04070107, 0.03535259, 0.02650747, 0.0228834, 0.01373761, 0.01041223, 0.00603878,
            0.,
        ]),
        lab_iter_kwh_per_mi: Array::from_vec(vec![
            0., 0.19912463, 0.19912463, 0.19912463, 0.19912463, 0.19912463, 0.19912463, 0.15040554,
            0.,
        ]),
        adj_iter_mpgge: Array::from_vec(vec![0., 0., 0., 0., 0., 0., 176.69300837, 43.2308293]),
        adj_iter_kwh_per_mi: Array::from_vec(vec![
            0., 0.28446375, 0.28446375, 0.28446375, 0.28446375, 0.28446375, 0.28446375, 0.21486505,
            0.,
        ]),
        adj_iter_cd_miles: Array::from_vec(vec![
            0.,
        ...
        adj_iter_uf_kwh_per_mi: Array::from_vec(vec![
            0., 0.04627656, 0.03380567, 0.03708269, 0.02264331, 0.02452931, 0.01923259, 0.00887393,
            0.,
        ]),
